...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM2)
  {
    ...
    PA0-WKUP     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(ENC1_CHA_INCAP_T2C1_GPIO_Port, ENC1_CHA_INCAP_T2C1_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM3)
  {
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, ENC1_CHA_T3C1_Pin|ENC1_CHB_T3C2_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  if(huart->Instance==USART1)
  {
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, RS485_U1_TX_Pin|RS485_U1_RX_Pin);
  ...
  else if(huart->Instance==USART2)
  {
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, DEBUG_TX_U2_Pin|DEBUG_RX_U2_Pin);
