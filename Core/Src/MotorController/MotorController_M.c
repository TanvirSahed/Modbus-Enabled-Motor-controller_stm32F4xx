...
//		return;
//	}
//	//mc->pos = (mc->path==MOTOR_CTRL_PATH_NORMAL)?pos: (360 - pos);
//	mc->pos = pos;
//
...
//	if(mc->pos > mc->setPos){
//		/*Down direction*/
//		mc->dir = MOTOR_CTRL_DIR_DOWN;//((mc->path==MOTOR_CTRL_PATH_NORMAL)? MOTOR_CTRL_DIR_DOWN:MOTOR_CTRL_DIR_UP);
//	}else if(mc->pos < mc->setPos){
//		/*up direction*/
//		mc->dir = MOTOR_CTRL_DIR_UP;//((mc->path==MOTOR_CTRL_PATH_NORMAL)? MOTOR_CTRL_DIR_UP:MOTOR_CTRL_DIR_DOWN);
//	}else{
//		return;
//	}
//
...
//        		actOnDownSen(mc);
//        		setNextState(mc, MOTOR_CTRL_SM_STATE_DOWN_POS_3);
//        	}else if((mc->dir == MOTOR_CTRL_DIR_UP)  //(mc->path==MOTOR_CTRL_PATH_NORMAL)?MOTOR_CTRL_DIR_UP:MOTOR_CTRL_DIR_DOWN
//        			&& !mc->isStartUp){
//        		/*T9: st 2 -> 6*/
//        		printInfo(mc);
...
//        	if(mc->dir == MOTOR_CTRL_DIR_DOWN){  //((mc->path==MOTOR_CTRL_PATH_NORMAL)?MOTOR_CTRL_DIR_DOWN:MOTOR_CTRL_DIR_UP)
//        		/*T9: st 4 -> 6*/
//        		printInfo(mc);
...
//        		actOnFault(mc);
//        		setNextState(mc, MOTOR_CTRL_SM_STATE_FAULT_7);
//        	}else if(mc->dir == MOTOR_CTRL_DIR_DOWN){ //((mc->path==MOTOR_CTRL_PATH_NORMAL)?MOTOR_CTRL_DIR_DOWN:MOTOR_CTRL_DIR_UP)
//        		printInfo(mc);
//        		if(mc->isStartUp){
...
//    	if(mc->motorIf->setDir(mc->dir) != MOTOR_CTRL_ERR_OK){
...
//	/*1. Set the up direction*/
//	if (mc->motorIf->setDir != NULL){
//    	if(mc->motorIf->setDir((mc->path==MOTOR_CTRL_PATH_NORMAL)?MOTOR_CTRL_DIR_UP:MOTOR_CTRL_DIR_DOWN) != MOTOR_CTRL_ERR_OK){
//    		setFault(mc, MOTOR_CTRL_FAULT_ON_SET_DOWN_DIR);
//    		return;
//    	}
//    	mc->dir = MOTOR_CTRL_DIR_UP;//((mc->path==MOTOR_CTRL_PATH_NORMAL)?MOTOR_CTRL_DIR_UP:MOTOR_CTRL_DIR_DOWN);
